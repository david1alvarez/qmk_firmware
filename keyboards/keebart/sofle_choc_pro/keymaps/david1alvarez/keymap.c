 ...
 */
 [MOVE] = LAYOUT_split_4x6_5(
    ...
    _______,_______,_______,_______,_______,_______,                  _______,MS_LEFT,MS_DOWN,MS_RGHT, KC_UP ,_______,
    _______,_______,_______,_______,_______,_______,   PB_1,   PB_2,  MS_BTN2,MS_BTN3,_______,KC_LEFT,KC_DOWN,KC_RGHT,
